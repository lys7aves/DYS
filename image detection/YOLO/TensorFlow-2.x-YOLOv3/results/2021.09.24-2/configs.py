...
TRAIN_CLASSES               = "K-Fashion/K-Fashion_top.names"
TRAIN_ANNOT_PATH            = "K-Fashion/K-Fashion_top_100_train.txt" #수정1
TRAIN_LOGDIR                = "log"
TRAIN_CHECKPOINTS_FOLDER    = "checkpoints"
TRAIN_MODEL_NAME            = f"{YOLO_TYPE}_custom"
TRAIN_LOAD_IMAGES_TO_RAM    = True # With True faster training, but need more RAM
TRAIN_BATCH_SIZE            = 8 #배치 사이즈
...
TRAIN_EPOCHS                = 10 # 에폭 바꾸기

# TEST options
TEST_ANNOT_PATH             = "K-Fashion/K-Fashion_top_25_val.txt" #수정2
TEST_BATCH_SIZE             = 8
TEST_INPUT_SIZE             = 512
TEST_DATA_AUG               = False
