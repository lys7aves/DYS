...
import time     # modified on 9/24
import datetime # modified on 9/24
...
start_time = time.time()    # modified on 9/24
...
print("time :", datetime.timedelta(seconds=time.time()-start_time))   # modified on 9/24